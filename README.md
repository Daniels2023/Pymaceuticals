Pymaceuticals is a data visualization project that was developed using Pandas, Scipy, and Matplotlib. The aim of this project was to analyze and visualize the results of drug testing on mice.
